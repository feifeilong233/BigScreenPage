...
-- ----------------------------
INSERT INTO `qrtz_scheduler_state` VALUES ('Qingfeng_Cloud_Scheduler', 'feifeilong2331682265020843', 1682265984374, 15000);
INSERT INTO `qrtz_scheduler_state` VALUES ('QuartzScheduler', 'feifeilong2331682265020297', 1682265981059, 20000);
...
CREATE TABLE `road_flatness`  (
  ...
  `type` int(2) NULL DEFAULT NULL COMMENT '数据类型, 1->平整度, 2->抗滑性能, 3->平均温度, 4->轴次对数, 5->轴次, 6->车辙深度, 7->FWD弯沉盆, 8->T路表, 9->T大气',
  `name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `value` decimal(50, 2) NULL DEFAULT NULL,
