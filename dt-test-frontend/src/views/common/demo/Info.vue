            ...
            <a-form v-bind="formLayout">
                <!-- 检查是否有 id 并且大于0，大于0是修改。其他是新增，新增不显示主键ID -->
                            ...
                            <a-form-item v-bind="validateInfos.name" label="名称">
                                <a-input disabled v-model:value="formRef.name" placeholder="名称" />
                            </a-form-item>
                            <a-form-item v-bind="validateInfos.order_by" label="排序">
                                <a-input disabled v-model:value="formRef.order_by" placeholder="排序" />
                            </a-form-item>
                            <a-form-item v-bind="validateInfos.remark" label="备注">
                                <a-textarea disabled v-model:value="formRef.remark" placeholder="备注" :rows="4" />
                            </a-form-item>
            </a-form>
        </a-spin>
    </a-modal>
