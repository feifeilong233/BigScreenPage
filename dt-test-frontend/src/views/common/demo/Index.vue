  ...
  <page-header-wrapper>
        <a-card :bordered="false">
          ...
          <div class="table-operator">
            <a-button type="primary" @click="handleAdd" v-action:demo:add
              ><plus-outlined />新建</a-button
            >
            <a-dropdown v-if="rowSelection.selectedRowKeys.length > 0" v-action:demo:del>
              <template #overlay>
            ...
            <template #bodyCell="{ column, text, record }">
              <span v-if="column.dataIndex === 'operation'">
                ...
                <a-button
                  size="small"
                  type="primary"
                  v-action-dauth:[{...record,auth:`demo:edit`}]
                ...
                <a-button
                  size="small"
                  type="danger"
                  v-action-dauth:[{...record,auth:`demo:del`}]
...
import { getListPage, delData, updateStatus ,saveOrUpdate } from "@/api/common/demo";
