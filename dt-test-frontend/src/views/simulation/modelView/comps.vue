      ...
      <div class="chartsdoms_cons_rights space-y-2 w-22vw">
        <div class="box1 enter-x-r w-22vw">
          ...
          <div class="h-40vh box-body">
            <a-row>
              <a-col :span="12">
                <a-slider @change="onChange" v-model:value="inputValue1" :min="0" :max="1" :step="0.01" />
              </a-col>
              <a-col :span="4">
                <a-input-number
                    @change="onChange"
            ...
            <a-row>
              <a-col :span="12">
                <a-slider @change="onChange" v-model:value="inputValue2" :min="0" :max="1" :step="0.01" />
              </a-col>
              <a-col :span="4">
                <a-input-number
                    @change="onChange"
...
const inputValue1 = ref(0.01);
const inputValue2 = ref(0.02);
